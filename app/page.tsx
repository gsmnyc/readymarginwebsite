...
export default async function Home() {
  ...
  const experience = (
    <div className="split">
      ...
      <div>
        <p className="lead">
          Ready Margin comes from hands-on restaurant operations and finance
          work.
        </p>
        <p>
          The changed shift. The tip question. The supplier bill that doesn’t
          look right. We built our approach around the jobs that keep an owner
          at the desk long after service.
        </p>
        <Link className="text-link" href="/about">
          Why we started Ready Margin ↗
        </Link>
      </div>
    </div>
  );
    ...
    <main id="main">
      ...
      <section id="home-hero" tabIndex={-1} className="hero container">
        <div className="hero-topline">
          <span className="eyebrow">
            Restaurant finance & operations, handled.
          </span>
        ...
        <div className="hero-grid">
          ...
          <div className="hero-support">
            ...
            <Link className="text-link" href="/what-we-handle">
              See what we handle ↘
            </Link>
          </div>
        </div>
      ...
      <section className="container section problem">
        ...
        <div className="split">
          ...
          <div>
            <p className="lead">
              A missing clock-out. A bill to check. Payroll coming up. And
              somehow, every question ends up with you.
            </p>
            <p>
              You can have a great team and a busy restaurant and still spend
              your evenings chasing the details behind it.
            </p>
            <p>
              We take on the recurring finance and operating work you agree with
              us, then make time to explain what it means for the business.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="section-heading split">
          <div>
            ...
            <h2>
              It all connects.
              <br />
              So should the support.
            </h2>
          </div>
          <p>
            A shift becomes payroll. A delivery becomes a bill. Those records
            shape the numbers you use to run the restaurant. Choose the part you
            need help with.
          </p>
        </div>
        <Workstreams />
        <div className="scope-bar">
          <span>Our managed services</span>
          <p>Choose the support you need. We agree the details together.</p>
          <Link href="/what-we-handle">Explore all six services ↗</Link>
        </div>
        <CapabilityGrid pages={c.pages} />
        <Link
          className="text-link local-link"
          href="/new-york-restaurant-bookkeeping"
        >
          Restaurant bookkeeping and payroll support in New York ↗
        </Link>
      </section>
      <section className="review-scene">
        <div className="container section split">
          <div>
            ...
            <p>
              A review should make that easy to answer. Here’s the issue, why it
              matters and the person who needs to act.
            </p>
            <Link className="text-link" href="/how-it-works/owner-view">
              Inside an owner review ↗
            </Link>
          </div>
          <ReviewCard />
        </div>
      ...
      <section className="container section">
        <div className="split section-heading">
          ...
          <p>
            The records come in. We check them, review the findings and follow
            up on what was agreed. Unfinished work stays on the list.
          </p>
        </div>
        <Timeline steps={c.pages.find((p) => p.kind === "rhythm")!.sections} />
        <Link className="text-link" href="/how-it-works/ready-rhythm">
      ...
      <section className="experience-section">
        <div className="container section">
          ...
          {[
            ...new Set([...c.settings.proofOrder, "experience", "workflow"]),
          ].map((item) =>
            item === "experience" ? (
      ...
      <section className="container section">
        ...
        <div className="fit-note">
          ...
          <p>
            We need your team’s records and an approver who stays involved. In
            return, you know which jobs we handle, what you’ll receive and when
      ...
      <section className="container section future-section">
        ...
        <div className="split">
          <div>
            ...
            <p>
              Managed accounting, payroll, operating support and reporting, with
              time to talk through the numbers.
            </p>
            <Link href="/what-we-handle" className="text-link">
          ...
          <div>
            ...
            <p>
              Dashboards, workbenches and deeper connections are part of our
              future direction. They are not released products, and no launch
